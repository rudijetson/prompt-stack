...
@lru_cache()
def get_database_service(table_name: str, model_class: Type[T]) -> SupabaseDatabaseService[T]:
    """
    Factory function to get a cached database service instance.
    ...
    """
    return SupabaseDatabaseService(table_name, model_class)
