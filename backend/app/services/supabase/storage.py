...
def get_storage_service(bucket_name: str = "default") -> SupabaseStorageService:
    """
    Factory function to get a storage service instance.
    ...
    """
    return SupabaseStorageService(bucket_name)
